...
class SignUpFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var username = view.findViewById<EditText>(R.id.signup_IDentry)
        var password = view.findViewById<EditText>(R.id.signup_passwordentry)
    ...
    private fun saveNewUser(username: EditText, password: EditText) {
