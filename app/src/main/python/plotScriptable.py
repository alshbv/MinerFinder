...
### this function was originally at #711, move it back if smth goes wrong
...
## this code is being converted into a function such that
## I can call it. 
## the function now needs to be changed so it takes a specific file name, not file path as input -
## one which I will feed in from the android app

def mainScriptable(usernameA): 
    ...
    filename = username_0final + "results.csv"
    dir1 = str(Python.getPlatform().getApplication().getFilesDir())

    folder_name = "Results"

    # path to "Results" directory
    results_folder_path = os.path.join(dir1, folder_name)

    # Check if "Results" exists, and if not, create it
